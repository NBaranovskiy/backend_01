...
exports.blogRoute
    ...
    .post('/:id/posts', params_id_validation_middleware_1.idValidation, (0, query_pagination_sorting_validation_middleware_1.paginationAndSortingValidation)(post_sort_field_1.PostSortField), input_validtion_result_middleware_1.inputValidationResultMiddleware, create_postToIdBlog_handler_1.createBlogsPostsListHandler)
