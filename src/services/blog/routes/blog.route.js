...
exports.blogRoute
    ...
    .post('/:id/posts', super_admin_guard_middleware_1.superAdminGuardMiddleware, params_id_validation_middleware_1.idValidation, (0, query_pagination_sorting_validation_middleware_1.paginationAndSortingValidation)(post_sort_field_1.PostSortField), input_validtion_result_middleware_1.inputValidationResultMiddleware, post_input_dto_validation_middlewares_1.titleValidation, post_input_dto_validation_middlewares_1.shortDescriptionValidation, post_input_dto_validation_middlewares_1.contentValidation, create_postToIdBlog_handler_1.createBlogsPostsListHandler)
